...
diabetes_model = pickle.load(open(r'C:/Users/anura/Desktop/Multiple_disease_predictive_system/saved_models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open(r'C:/Users/anura/Desktop/Multiple_disease_predictive_system/saved_models/heart_disease_model.sav', 'rb'))

parkinsons_model = pickle.load(open(r'C:/Users/anura/Desktop/Multiple_disease_predictive_system/saved_models/parkinsons_model.sav', 'rb'))

breast_model = pickle.load(open(r'C:/Users/anura/Desktop/Multiple_disease_predictive_system/saved_models/breast_model.sav', 'rb'))
...
with st.sidebar:
    selected = option_menu('Multiple Disease Predictive System ',
                           ...
                           icons=['activity', 'heart-pulse', 'person','virus2'],
                           default_index=0)
...
if (selected == 'Heart Disease Prediction'):
    ...
    with col3:
        cp = st.text_input('Chest Pain types{1-4}(cp)')
    ...
    with col3:
        fbs = st.text_input('Fasting Blood Sugar (fbs){1 =>120, 0 =<120 mg/dl')
...
if (selected == "Breast Cancer Prediction"):
  ...
  # ___________________________________________END OF THE CODE __________________________________________      
